...
import { postFbImg } from '../../../../actions/fbpostsAction'
...
const FbPostForm = () => {
    ...
    const uploadImage = () => {
        ...
        formData.append("upload_preset", "ttkkcaat")

        Axios.post(`https://api.cloudinary.com/v1_1/doxftieng/auto/upload`, formData)
            .then((res) => {
                dispatch(postFbImg({
